 ...
 */
final class Version20240219235501 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE nem ADD author_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_9681BD3FF675F31B');
        $this->addSql('ALTER TABLE nem DROP author_id');
